...
| **[ADR-0006](ADR-0006-redis-fail-open-cache-aside.md)**         | Accepted | Redis fail-open cache-aside (no health Proxy), per-concern degradation, cache generation invalidation, slim Redis layering + shared connection options.                       | 2026-08-21 | —          | —             | `src/infrastructure/redis/`, cached repository DI, readiness/health            |
