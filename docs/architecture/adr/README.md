...
| **[ADR-0007](ADR-0007-admin-analytics-query-composition.md)** | Accepted | Admin analytics as query-only composition module (`/v1/admin/analytics/*`); SQL projections not ACL/Prometheus; UTC + range safeguards. | 2026-08-30 | - | - | `src/modules/analytics/` |
| **[ADR-0008](ADR-0008-money-snapshot-and-store-currency.md)** | Accepted | Money Snapshot, Cart Domain Currency Boundaries, and CQRS Separation (line Money snapshotting, mono-currency invariant, CreateCart returns `ICart` primitives). | 2026-09-12 | - | - | `src/modules/carts/` |
